...
function getToolSchemas(enabledTools, mode) {
  const schemas = {
    ...
    closeCipypCad: { type: 'function', function: { name: 'closeCipypCad', description: '关闭 CIPYP-CAD 窗口(未保存的修改会丢失, 请先调用 saveCipypCadProject)', parameters: { type: 'object', properties: {}, required: [] } } },
