...
const EN_DICT = {
  ...
  _tools: {
    ...
    // CIBYP-PCB-EDA
    initPcbEda: 'Open CIBYP-PCB-EDA standalone window (schematic + PCB design)',
    closePcbEda: 'Close CIBYP-PCB-EDA window',
    pcbNewProject: 'Create new PCB project (name/size/layers)',
    pcbSetDesignRules: 'Set PCB design rules (clearance/width/drill, all params)',
    pcbSetStackup: 'Set PCB layer stackup (copper layers/thickness/material)',
    pcbSetOutline: 'Set board outline (polygon vertices)',
    pcbSchAddSymbol: 'Place schematic symbol (R/C/IC/connector etc.)',
    pcbSchAddWire: 'Draw schematic wire',
    pcbSchAddLabel: 'Place schematic net label',
    pcbSchAddPower: 'Place power symbol (GND/VCC etc.)',
    pcbSchAnnotate: 'Auto-annotate schematic designators',
    pcbSchSync: 'Synchronize schematic to PCB (components + nets)',
    pcbRunERC: 'Run schematic electrical rule check (ERC)',
    pcbAddComponent: 'Place PCB component (footprint + full params)',
    pcbMoveComponent: 'Move PCB component to coordinates',
    pcbRotateComponent: 'Rotate PCB component',
    pcbDeleteComponent: 'Delete PCB component',
    pcbListComponents: 'List all PCB components with pad nets',
    pcbSetPadNet: 'Assign net to component pad',
    pcbRouteTrace: 'Route PCB trace (net/layer/width/path)',
    pcbAddVia: 'Place PCB via',
    pcbAddCopperPour: 'Add copper pour zone (polygon + clearance + thermal)',
    pcbAddSilkscreen: 'Add silkscreen (line/rect/circle/text)',
    pcbRunDRC: 'Run PCB design rule check (DRC)',
    pcbAutoroute: 'Autoroute nets (A* grid router)',
    pcbGetBoardInfo: 'Get PCB board statistics and status',
    pcbListLibrary: 'List footprint/symbol libraries',
    pcbSaveProject: 'Save PCB project (single/multi file)',
    pcbLoadProject: 'Load PCB project file',
    pcbImportFile: 'Import other EDA files (KiCad pcb/netlist, CSV netlist)',
    pcbExportGerber: 'Export Gerber production package (RS-274X + drill, zip)',
    pcbExportFile: 'Export KiCad/netlist/SVG/PNG/3D OBJ/PnP/BOM file',
    runPcbEdaCommand: 'Execute a single PCB-EDA command',
    runPcbEdaCommands: 'Execute multiple PCB-EDA commands in batch',
